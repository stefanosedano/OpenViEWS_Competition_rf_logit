...
def get_all_taddas(obs, pred):
    out={
    "mea": mean_absolute_error(obs, pred),
    "TADDA_1": tadda_score(obs, pred, 1),
    "TADDA_2": tadda_score(obs, pred, 2),
    "TADDA_GFFO": tadda_GFFO(obs, pred, 2),
    }
    return out
